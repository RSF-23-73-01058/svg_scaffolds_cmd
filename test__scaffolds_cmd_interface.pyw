...
def process_input(data):
	...
	meta_data = {'scaffold_type': data_base['meta']['scaffold_type'], 'processed': n_structures, 'repeats': smiles_repeats, 'failed_parse': failed_mol, 'failed_mw': failed_mw, 'failed_bond': failed_bond}
	#Count scaffolds
